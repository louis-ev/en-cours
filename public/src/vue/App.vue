<template>
  <div id="app">
    <template v-if="$root.state.mode === 'live'">
      <SystemBar v-if="$root.settings.enable_system_bar" :withTitleBar="true"></SystemBar>
      ...
      <div class="m_activitiesPanel">
        <div class="m_activitiesPanel--do" :class="{ 'is--large' : activitiesPanel_isLarge }">
          <div style="position: relative; height: 100%; overflow: hidden;">
            <transition name :duration="500">
              <ListView :read_only="!$root.state.connected" :projects="$root.store.projects" />
            </transition>
            <transition name :duration="600">
              <ProjectView
